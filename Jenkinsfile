def litecoin_repo = 'git@github.com:adisharma96/litecoin.git'

properties([
  parameters([
    string(name: 'litecoin_repo_branch', description: 'Branch to build and deploy Litecoin from', defaultValue: 'master'),
    string(name: 'image_repo_tag', description: 'Full Docker image name with repository included.', defaultValue: 'adisharma96/lite-test'),
